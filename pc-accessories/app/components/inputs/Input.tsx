    ...
    return (
        <div className="w-full relative">
            ...
            <input id={id} disabled={disabled} {...register(id, {required})} placeholder=" " type={type}
                   className={
                       `peer w-full p-4 font-light bg-white border-2 rounded-md outline-none transition 
            ...
            <label htmlFor={id} className={
                `absolute text-xs duration-150 transform -translate-y-3 top-5 z-10 origin-[0] hover:cursor-text
